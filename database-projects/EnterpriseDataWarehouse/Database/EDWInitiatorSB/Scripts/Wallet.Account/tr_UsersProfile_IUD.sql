CREATE OR ALTER TRIGGER dbo.tr_UsersBlockService_IUD
    ON [dbo].[Users_Profile]
    ...
    BEGIN TRY
        BEGIN
            ...
            EXEC [EDWInitiatorSB].dbo.sp_SendMessage_Users
                ...
                @MessageTypeName    =   N'//WalletAccount/UsersProfile/Request',
...
EXEC sp_settriggerorder @triggername = N'[dbo].[tr_UsersBlockService_IUD]',
                        @order = N'Last',
                        @stmttype = N'DELETE'
GO
