CREATE OR ALTER TRIGGER dbo.tr_UsersSecureConfig_IUD
    ON [dbo].[Users_SecureConfig]
    ...
    BEGIN TRY
        BEGIN
            ...
            EXEC [EDWInitiatorSB].dbo.sp_SendMessage_Users
                ...
                @MessageTypeName    =   N'//WalletAccount/UsersSecureConfig/Request',
...
EXEC sp_settriggerorder @triggername = N'[dbo].[tr_UsersSecureConfig_IUD]',
                        @order = N'Last',
                        @stmttype = N'DELETE'
GO
