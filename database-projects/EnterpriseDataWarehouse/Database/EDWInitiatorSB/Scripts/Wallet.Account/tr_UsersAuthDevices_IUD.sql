CREATE OR ALTER TRIGGER [dbo].[tr_UsersAuthDevices_IUD]
    ON [dbo].[Users_AuthDevices]
    ...
    BEGIN TRY
        BEGIN
            ...
            EXEC [EDWInitiatorSB].dbo.sp_SendMessage_Users
                ...
                @MessageTypeName    =   N'//WalletAccount/UsersAuthDevices/Request',
...
ALTER TABLE [dbo].[Users_AuthDevices] ENABLE TRIGGER [tr_UsersAuthDevices_IUD]
GO

EXEC sp_settriggerorder @triggername=N'[dbo].[tr_UsersAuthDevices_IUD]', @order=N'Last', @stmttype=N'DELETE'
GO

EXEC sp_settriggerorder @triggername=N'[dbo].[tr_UsersAuthDevices_IUD]', @order=N'Last', @stmttype=N'INSERT'
GO

EXEC sp_settriggerorder @triggername=N'[dbo].[tr_UsersAuthDevices_IUD]', @order=N'Last', @stmttype=N'UPDATE'
GO
